...
#define yyparse         yyoldparse
#define yylex           yyoldlex
#define yyerror         yyolderror
#define yylval          yyoldlval
#define yychar          yyoldchar
#define yydebug         yyolddebug
#define yynerrs         yyoldnerrs
